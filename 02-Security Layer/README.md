...
## 🛠️ Module 1: Management Plane Isolation
...
<br>
*Figure 1: Initial secure login to the pfSense gateway from the Windows Server (Ref: image_6ab8f3.png).*
...
> If you are unable to move your custom block rules above the default pfSense rules, you must manually disable the built-in safety (Ref: image_6a3cb7.png):
...
<img src="../assets/block-rule-config.png" alt="Firewall Rule Configuration" width="600">
<br>
*Figure 2: Configuring the specific block rule for the Windows 11 workstation (Ref: image_6ab478.png).*
...
<img src="../assets/final-ping-test.png" alt="Successful Internet Ping and Blocked Gateway" width="600">
<br>
*Figure 3: Final proof of concept: Internet access is active, but the internal gateway is invisible to the client (Ref: image_5f717e.png).*
